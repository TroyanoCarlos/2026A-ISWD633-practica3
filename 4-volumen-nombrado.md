...
```
docker run -d --name server-postgres -e POSTGRES_DB=db_drupal -e POSTGRES_PASSWORD=12345 -e POSTGRES_USER=user_drupal --network net-drupal -v vol-postgres:/var/lib/postgresql/data postgres:15
```
_No es necesario exponer el puerto, debido a que nos vamos a conectar desde la misma red de docker_

### Crear un cliente postgres vinculado a la red drupal a partir de la imagen dpage/pgadmin4, completar el correo
```
docker run -d --name client-postgres --publish published=9500,target=80 -e PGADMIN_DEFAULT_PASSWORD=54321 -e PGADMIN_DEFAULT_EMAIL=admin@email.com --network net-drupal dpage/pgadmin4
```
...
<img width="1641" height="942" alt="image" src="https://github.com/user-attachments/assets/df472273-db2b-4777-b93c-f1d3694a7c43" />

_La instalación puede tomar varios minutos, mientras espera realice un diagrama de los contenedores que ha creado en este apartado._

# COMPLETAR CON EL DIAGRAMA SOLICITADO

<img width="837" height="673" alt="image" src="https://github.com/user-attachments/assets/d57ef5e4-71ea-4ff8-aa7b-8405b0effd0b" />
